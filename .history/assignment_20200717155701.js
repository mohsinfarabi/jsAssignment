...
/* 
Code to check the function feetToMIle
...
/* 
Code to check the function woodCalculator
var chair = 1.0;
var table = 2.0;
var bed = 2.0;
...
/*
Code to check the function brickCalculator
var floors = 21.0;
console.log("Bricks Required: " + brickCalculator(floors));
*/
...
function tinyFriend(nameList) {
    if (nameList.length == 0) {
        console.log("Name List is empty"); // Validation for empty Name List
    } else {
        ...
        for (var i = 0; i < nameList.length; i++) {
            ...
            if (typeof nameList[i] != 'string') {
                console.log("Name should be string type"); // validation for string type name
            } else if (currentName.length < tinyName.length) {
...
/* 
code to check the function tinyFriend
var smallestName = tinyFriend(['joe', 'died', 'fater', 'as', 2]);

console.log("SmallestName is : " + smallestName);
*/