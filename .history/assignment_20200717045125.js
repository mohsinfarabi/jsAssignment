...
function feetToMile(feet) {
    ...
    if (feet < 0) {
        console.log("Distance can not be negative. Insert a value greater than or equal to 0"); // Validation for the negative value
    } else if (typeof feet == "string") {
        console.log("Distance can not be a string. Insert a value greater than or equal to 0"); //validation for string input
    } else {
...
function woodCalculator(chair, table, bed) {
    ...
    */
    ...
    if (chair < 0 || table < 0 || bed < 0) {
        console.log("Quantity can not be negative. Insert a value greater than or equal to 0"); // Validation for the negative value
    } else if (typeof chair == "string" || typeof table == "string" || typeof bed == "string") {
        console.log("Quantity can not be a string. Insert a value greater than or equal to 0"); //validation for string input
    } else {
...
function brickCalculator(floors) {
    ...
    */
    ...
    if (floors < 0) {
        console.log("Floor number can not be negative. Insert a value greater than or equal to 0"); // Validation for the negative value
    } else if (typeof floors == "string") {
        console.log("Floor number can not be a string. Insert a value greater than or equal to 0"); //validation for string input
