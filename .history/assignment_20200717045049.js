...
function feetToMile(feet) {
    ...
    } else if (typeof feet == "string") { //validation for string input
        console.log("Distance can not be a string. Insert a value greater than or equal to 0");
    } else {
...
function woodCalculator(chair, table, bed) {
    ...
    */
    ...
    if (chair < 0 || table < 0 || bed < 0) {
        return console.log("Quantity can not be negative. Insert a value greater than or equal to 0"); // Validation for the negative value
