...
function woodCalculator(chair, table, bed) {
    ...
    */
    ...
    } else if (typeof chair == "string" || typeof table == "string" || typeof bed == "string") { //validation for string input
        console.log("Quantity can not be a string. Insert a value greater than or equal to 0");
    } else {
